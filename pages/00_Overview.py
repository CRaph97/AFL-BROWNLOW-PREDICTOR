"""
2026 Brownlow Model -- Overview (leaderboard landing view).

Read-only presentation layer over the frozen, audited Phase 4 / 2026
production outputs. Formerly the app's default page (app.py); moved here so
"Guide & FAQs" can be the default landing page instead. Run the app with:
